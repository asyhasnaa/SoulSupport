package com.dicoding.soulsupport.data.database

import com.dicoding.soulsupport.R

object GenerateDummyArticles {
    fun generateDummyArticle(): List<Article> {
        val dummyArticle = mutableListOf<Article>()
        ...
        dummyArticle.add(
            Article(
                2,
                R.drawable.kesehatan_mental_pada_remaja,
        ...
        dummyArticle.add(
            Article(
                3,
                R.drawable.world_mental_health_day,
                "Pentingnya Menjaga Kesehatan Mental bagi Pekerja Muda\n",
                "Ditinjau oleh dr. Fadhli Rizal Makarim 25 Oktober 2023\n" +
                        " \n" +
                        ...
                        "\n" +
                        "Halodoc, Jakarta – Kesehatan mental merupakan salah satu persoalan yang kerap dihadapi oleh pekerja muda. Seiring dengan perkembangan zaman, para pekerja muda dihadapkan oleh banyaknya tantangan yang semakin kompleks hingga memengaruhi kondisi mentalnya.\n" +
                        ...
                        " \n" +
                        "Beberapa orang juga ada yang masih menganggap masalah mental adalah tabu. Hal ini yang membuat mereka tidak mau mencari perawatan. Padahal jika tak tertangani, Masalah Mental Bisa Memengaruhi Kesehatan Fisik dan menurunkan kualitas hidup pengidapnya.\n" +
