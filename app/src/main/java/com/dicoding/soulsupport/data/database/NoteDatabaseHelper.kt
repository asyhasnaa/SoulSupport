...
class NoteDatabaseHelper(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val createTableQuery =
            "CREATE TABLE $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY, $COLUMN_TITLE TEXT, $COLUMN_DESC TEXT, $COLUMN_DATE TEXT)"
    ...
    fun insertNote(note: Note) {
        ...
        val values = ContentValues().apply {
            ...
            put(COLUMN_DATE, DateFormatter.dateFormat())
        }
    ...
    fun getNoteByID(noteId: Int):Note{
        ...
        cursor.close()
        db.close()
        return Note(id, title, desc, date)
    }
